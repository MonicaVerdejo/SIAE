...
<body>
  ...
  <div class="page">
              ...
              <div class="rd-navbar-panel">
                ...
                <div class="rd-navbar-brand">
                  ...
                  <a class="brand" href="index.html">
                    <img class="brand-logo-desktop" src="img/logos/tecnm.svg" alt="tecnmChampoton" width="200"
                      height="110" />
                    <img class="brand-logo-mobile" src="img/logos/tecnm.svg" alt="" width="192" height="65" />
                  </a>
                  <!--logo itescham
                   <a class="brand" href="index.html">
                    <img class="brand-logo-desktop" src="img/logos/logo-default.svg" alt="tecnmChampoton" width="200"
                      height="110" />
                    <img class="brand-logo-mobile" src="img/logos/logo-default.svg" alt="" width="192" height="65" />
                  </a>
                  -->
                  ...
                  <ul class="contacts-classic">
                    ...
                    <li>
                      ...
                      <ul class="list-inline list-social list-inline-sm">
                        <a href="http://champoton.tecnm.mx/portal/" target="_blank"><i class="fa fa-internet-explorer"
                            aria-hidden="true"></i></a>

                        <li><a class="icon fa fa-twitter" href="https://twitter.com/ITESCHAM" target="_blank"></a></li>
                        <li><a class="icon fa fa-facebook" href="https://m.facebook.com/ITESCHAM/" target="_blank"></a>
                        </li>
                        <li><a class="icon fa fa-instagram" href="https://www.instagram.com/itescham/"
                            target="_blank"></a></li>
                      </ul>
                    </li>
                  </ul>
      ...
      <div class="container">
        <div class="title-style-1-wrap">
          <div class="oh-desktop wow slideInLeft">
            <h1 class="title-style-1 wow slideInRight">SIAE</h1>
          </div>
        </div>
        <div class="title-style-2-wrap">
          <div class="oh-desktop wow slideInRight">
            <h5 class="title-style-2 wow slideInLeft">Sistema Integral de Actividades Extraescolares</h5>
          </div>
        </div><a class="button button-default wow fadeInUp" href="contacto.html">Acerca de nosotros</a>
      </div>
    </section>
    <!-- About Us-->
      ...
      <div class="container">
        <div class="row row-30 justify-content-center">
          <div class="col-sm-9 col-md-5 cube-classic-wrap">
            <div class="subtitle-classic wow fadeInLeft">Bienvenido a nuestro sitio</div>
            <h2 class="wow fadeInLeft">Tu pasión <br class="d-none d-md-block"><span class="text-primary">inicia</span>
              con la elección <br class="d-none d-md-block">de nuestros talleres
            </h2>
            <div class="cube-classic cube-classic-1"><span class="cube-classic-item"></span><span
                class="cube-classic-item"></span><span class="cube-classic-item"></span><span
                class="cube-classic-item"></span><span class="cube-classic-item"></span><span
                class="cube-classic-item"></span><span class="cube-classic-item"></span><span
                class="cube-classic-item"></span><span class="cube-classic-item"></span><span
                class="cube-classic-item"></span><span class="cube-classic-item"></span><span
          ...
          <div class="col-md-7 col-lg-6 col-xl-5">
            <p class="wow fadeInRight">SIAE es un creativo sitio web que integra la información de todos los talleres
              que el Instituto Tecnológico
              Superior de Champotón imparte dentro de sus actividades extraescolares, este sitio se creó con el
              propósito de acercarse a los
              estudiantes que están interesados en unirse a la matrícula escolar.
            </p>
            <p class="wow fadeInRight">Aquí tendrás toda la información que necesitas a la distancia de un clic.
            </p><a class="wow fadeInRight button button-default" href="contacto.html">Más acerca de nosotros</a>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row row-30 justify-content-center justify-content-lg-end align-items-md-center">
          <div class="col-sm-8 col-md-6 col-lg-5 cube-classic-wrap">
            <div class="subtitle-classic wow fadeInLeft">Escoge tú pasión</div>
            <h2 class="wow fadeInLeft" data-wow-delay=".1s">Conoce <br class="d-none d-md-block">nuestros
              <br class="d-none d-md-block">talleres
            </h2>
            <p class="wow fadeInLeft">Constantemente estamos innovando las actividades que se imparten en el ITESCHAM,
              con el
              propósito de mantenerte interesado en cursar los talleres y así juntar exitosamente tus creditos
              extraescolares.
            </p>
          ...
          <div class="col-sm-8 col-md-6 wow blurIn">
            <div class="inset-xl-left-25">
              <!-- Owl Carousel-->
              <div class="owl-carousel owl-style-1" data-loop="true" data-items="1" data-nav="true">
                <img src="img/slider/3.jpg" alt="" width="618" height="614" />
                <img src="img/slider/4.jpg" alt="" width="618" height="614" />
                <img src="img/slider/5.jpg" alt="" width="618" height="614" />
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="section section-full section-xl bg-default text-md-center" id="projects">
      <div class="container">
        <div class="subtitle-classic wow fadeInUp">Talleres</div>
        <h2><span class="d-inline-block wow fadeInLeft">Clasificación de</span> <span
            class="text-primary d-inline-block wow fadeInRight">nuestros cursos</span>
        </h2>
        <div class="row row-lg row-30">
          <div class="col-sm-6 col-md-4 wow blurIn" data-wow-delay=".2s">
            <article class="project-classic box-md"><img src="img/cultura/1.jpg" alt="" width="370" height="262" />
              <div class="project-classic-caption">
                <div>
                  <h4 class="project-classic-title"><a href="#">Culturales</a></h4>
                  <div class="project-classic-tag">Vive el arte.</div>
                </div>
              </div>
            </article>
          </div>
          <div class="col-sm-6 col-md-4 wow blurIn" data-wow-delay=".1s">
            <article class="project-classic box-md"><img src="img/deporte/1.jpg" alt="" width="370" height="262" />
              <div class="project-classic-caption">
                <div>
                  <h4 class="project-classic-title"><a href="#">Deportivos</a></h4>
                  <div class="project-classic-tag">Una vez que algo es una pasión, hay motivación.</div>
                </div>
              </div>
            </article>
          </div>
          ...
          <div class="col-sm-6 col-md-4 wow blurIn" data-wow-delay=".2s">
            <article class="project-classic box-md"><img src="img/civico/1.jpg" alt="" width="370" height="262" />
              <div class="project-classic-caption">
                <div>
                  <h4 class="project-classic-title"><a href="#">Cívico</a></h4>
                  <div class="project-classic-tag">La solidaridad es la ternura de la patria.</div>
                </div>
              </div>
            </article>
          </div>
    ...
    <footer
      ...
      id="contacts">
      <img class="mb-3" src="img/slider/comunidadDigital.jpg" alt="comunidadDigital">
      ...
      <div class="container">
        ...
        <p class="rights wow fadeInUp"><span>&copy;&nbsp; </span><span
            class="copyright-year"></span><span>&nbsp;</span><span>SIAE</span><span>.&nbsp;</span><span>Todos los
            derechos reservados.</span>
          <br />Diseñado&nbsp;por&nbsp;<a href="#">Softup</a></p>
      </div>
    </footer>
  </div>

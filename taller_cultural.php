...
<body>
    ...
    <div class="page">
        ...
        <section class="section section-inset-1 bg-default text-center bg-image background-position-1" id="home" style="background-image: url(img/img_portada/cultural/cultural.jpg)">
            <div class="container">

...
<body>
    ...
    <div class="page">
                            ...
                            <div class="rd-navbar-nav-wrap">
                                <div class="rd-navbar-nav-container">
                                    ...
                                    <ul class="contacts-classic">
                                        <li>
                                            <div class="contacts-classic-title">Teléfono:</div><a href="tel:+529828282432">9828282432</a>
                                        </li>
                                        <li>
        ...
        <section class="section section-inset-1 bg-default text-center bg-image background-position-1" id="home" style="background-image: url(img/img_portada/deportivo/deportivo.jpg)">
            <div class="container">
                <div class="title-style-1-wrap">
                    <div class="oh-desktop wow slideInLeft">
                        <h1 class="title-style-1 wow slideInRight">Talleres deportivos</h1>
                    </div>
                </div>
            </div>
        </section>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-12 mb-5">
                    <div class="special-menu text-center">
                        <a class="btn btn-dark" style="color:white;">DEPORTE</a>
                    </div>
                </div>
            </div>
            <!--CATEGORIA CULTURAL-->
            <div>
                <main class="container">
                    <?php
                    $response = json_decode(file_get_contents('http://localhost/SIAE2/galeria/api-talleres.php?categoria=Deportivo'), true);
